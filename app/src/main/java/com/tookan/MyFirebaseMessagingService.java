...
import tookan.sdk.models.TookanNotificationConfig;
...
public final class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (tookanNotification.isTookanPushNotification(remoteMessage.getData())) {
            tookanNotification.setSmallIcon(R.mipmap.ic_tkn_notif); //your icon drawable
...
//        else
//    sendNotification("come notification");
